  ...
  private static File convertGLFile(File originalFile) throws IOException {
    ...
    try {
      ...
      for (String line : new FileLineIterable(originalFile, false)) {
        ...
        String[] spline = line.split(COLON_DELIMTER);
        try {
        	int userId = Integer.valueOf(spline[0]) + 10000;
        	 writer.write(userId+","+spline[1]+","+spline[2]+"\n");
		} catch (Exception e) {
			 writer.write(spline[0]+","+spline[1]+","+spline[2]+"\n");
		}
